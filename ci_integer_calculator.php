...
Version: 1.0.0
Author: Integer Calculator / www.calculator.io
...
function display_calcio_ci_integer_calculator(){
    $page = 'index.html';
...
add_shortcode( 'ci_integer_calculator', 'display_calcio_ci_integer_calculator' );